...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Note'
        db.create_table('poplar_note', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(related_name='notes', to=orm['auth.User'])),
            ('subject', self.gf('django.db.models.fields.related.ForeignKey')(related_name='notes', to=orm['poplar.Person'])),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')()),
            ('is_public', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('body', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('poplar', ['Note'])


    def backwards(self, orm):
        
        # Deleting model 'Note'
        db.delete_table('poplar_note')
